...
Note: the following methods aren't wrapped: GetScrollbars, GetScrollX,
GetScrollY, ScrollTo, ScrollBy, ScrollByLines, ScrollByPages.
(Only GetScrollbars would be non-trivial to wrap, just didn't
get around to the others yet.)
